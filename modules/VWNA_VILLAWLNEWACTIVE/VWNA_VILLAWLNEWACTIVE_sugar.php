 ...
 * PLACE ANY CUSTOMIZATIONS IN VWNA_VILLAWLNEWACTIVE
 */

require_once('include/SugarObjects/templates/person/Person.php');

class VWNA_VILLAWLNEWACTIVE_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'VWNA_VILLAWLNEWACTIVE';
	var $object_name = 'VWNA_VILLAWLNEWACTIVE';
	var $table_name = 'vwna_villawlnewactive';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function VWNA_VILLAWLNEWACTIVE_sugar(){	
		parent::Person();
	}
