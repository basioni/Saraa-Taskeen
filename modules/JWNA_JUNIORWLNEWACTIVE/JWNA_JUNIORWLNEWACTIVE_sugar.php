 ...
 * PLACE ANY CUSTOMIZATIONS IN JWNA_JUNIORWLNEWACTIVE
 */

require_once('include/SugarObjects/templates/person/Person.php');

class JWNA_JUNIORWLNEWACTIVE_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'JWNA_JUNIORWLNEWACTIVE';
	var $object_name = 'JWNA_JUNIORWLNEWACTIVE';
	var $table_name = 'jwna_juniorwlnewactive';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function JWNA_JUNIORWLNEWACTIVE_sugar(){	
		parent::Person();
	}
