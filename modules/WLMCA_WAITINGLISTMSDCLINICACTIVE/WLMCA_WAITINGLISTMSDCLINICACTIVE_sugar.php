 ...
 * PLACE ANY CUSTOMIZATIONS IN WLMCA_WAITINGLISTMSDCLINICACTIVE
 */

require_once('include/SugarObjects/templates/person/Person.php');

class WLMCA_WAITINGLISTMSDCLINICACTIVE_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'WLMCA_WAITINGLISTMSDCLINICACTIVE';
	var $object_name = 'WLMCA_WAITINGLISTMSDCLINICACTIVE';
	var $table_name = 'wlmca_waitinglistmsdclinicactive';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function WLMCA_WAITINGLISTMSDCLINICACTIVE_sugar(){	
		parent::Person();
	}
