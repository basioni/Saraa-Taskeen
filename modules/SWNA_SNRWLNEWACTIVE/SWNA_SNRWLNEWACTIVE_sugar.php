 ...
 * PLACE ANY CUSTOMIZATIONS IN SWNA_SNRWLNEWACTIVE
 */

require_once('include/SugarObjects/templates/person/Person.php');

class SWNA_SNRWLNEWACTIVE_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'SWNA_SNRWLNEWACTIVE';
	var $object_name = 'SWNA_SNRWLNEWACTIVE';
	var $table_name = 'swna_snrwlnewactive';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function SWNA_SNRWLNEWACTIVE_sugar(){	
		parent::Person();
	}
