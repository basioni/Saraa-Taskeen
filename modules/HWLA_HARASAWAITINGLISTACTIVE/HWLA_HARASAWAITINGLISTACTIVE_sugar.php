 ...
 * PLACE ANY CUSTOMIZATIONS IN HWLA_HARASAWAITINGLISTACTIVE
 */

require_once('include/SugarObjects/templates/person/Person.php');

class HWLA_HARASAWAITINGLISTACTIVE_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'HWLA_HARASAWAITINGLISTACTIVE';
	var $object_name = 'HWLA_HARASAWAITINGLISTACTIVE';
	var $table_name = 'hwla_harasawaitinglistactive';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function HWLA_HARASAWAITINGLISTACTIVE_sugar(){	
		parent::Person();
	}
